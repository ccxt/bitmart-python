...
- `private_post_spot_v4_algo_submit_order(request)`
- `private_post_spot_v4_algo_cancel_order(request)`
- `private_post_spot_v4_algo_cancel_all(request)`
- `private_post_spot_v4_query_algo_order(request)`
- `private_post_spot_v4_query_algo_client_order(request)`
- `private_post_spot_v4_query_algo_open_orders(request)`
- `private_post_spot_v4_query_algo_history_orders(request)`
...
- `describe(self)`
- `subscribe(self, unifiedName, channel, symbol, type, params={})`
- `subscribe_multiple(self, unifiedName: str, channel: str, type: str, symbols: Strings = None, params={})`
...
- `subscription_exists_for_hash(self, url: str, hash: str)`
